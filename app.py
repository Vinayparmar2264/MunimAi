# app.py
"""
MerchAI — AI-Driven Retail Merchandising Engine  v6.0
app.py  |  Technoverse Hackathon 2026  |  Cognizant
...
def load_models():
    ...
    try:
        ...
        m["loaded"] = True
        print(f"[MerchAI v6] ✓ All 4 models loaded successfully")
        ...
        print(f"[MerchAI v6] ⚠ Model loading failed: {e}")
